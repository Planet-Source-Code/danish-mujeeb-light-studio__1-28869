...
If c = 1 Then Picture1.Cls
    ...
    For i = 1 To Picture1.Width Step HScroll2.Value
        For j = 1 To Picture1.Height Step HScroll2.Value
            ...
            If c = 2 Then Picture1.Line (i, j)-((i + HScroll2.Value), (j + HScroll2.Value)), RGB(rin, gin, bin), BF
            If c = 1 Then Picture1.PSet (i, j), RGB(rin, gin, bin)
...
SavePicture Picture1.Picture, "hoho.bmp"
End Sub
